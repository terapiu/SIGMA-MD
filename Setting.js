...
global.owner = process.env.OWNER_NUMBER  || '94756260023' ;  // ADD YOUR NUMBER WITHOUT +
global.mongodb = process.env.MONGODB_URI || "mongodb://uumgabx35wjieywskhcf:ppyoWuhSZP0plEqD5tNg@n1-c2-mongodb-clevercloud-customers.services.clever-cloud.com:27017,n2-c2-mongodb-clevercloud-customers.services.clever-cloud.com:27017/b3tnngrwqxgwmyr?replicaSet=rs0" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
...
global.sudo  =  process.env.SUDO || "94756260023" ;          // DON'T REMOVE
global.mztit = process.env.MZTIT ||"MR.TERA",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '02_04_2024_SIGMA_MD_N08Dku01_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'TERA',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `MR.TEHERAN`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'MR.TEHERAN👤',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "PIUSHA🗿" ,          // ADD YOUR STICKER PACKNAME
  ...
  OPENAI_API_KEY: process.env.OPENAI_API_KEY ||'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' ,    // ADD YOUR OPEN AI KEY IF YOU HAVE
